...
\fxnote{The first objective outline; different types of polling, registration, embedded servers}{
\paragraph{Objective 1: Device tracking.} ~\\
- taxonomy of devices \\
...
\fixme{I'm not sure why this is here.  Is the original list too specific?}{
\begin{enumerate}
...
Specific deliverables from the outlined tasks include:
